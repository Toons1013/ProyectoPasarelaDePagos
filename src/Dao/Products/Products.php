...
class Products extends Table
{
    ...
    {
        $sqlstr = "SELECT p.productId, p.productName, p.productDescription, p.productPrice, p.productImgUrl, p.productStatus FROM products p WHERE p.productStatus = 'ACT' ORDER BY p.productId";
        $params = [];
        $registros = self::obtenerRegistros($sqlstr, $params);
